/**
 * Raydium CLMM Usage Examples
 *
 * This example demonstrates using the Raydium CLMM integration for
 * trading on Raydium Concentrated Liquidity Market Maker pools.
 *
 * Prerequisites:
...
async function main() {
  console.log('LYS Flash - Raydium CLMM Examples\n');
  ...
  try {
    ...
    console.log('2. Static Utilities (RaydiumCLMMUtils)');
    console.log('   ────────────────────────────────────\n');
    ...
    console.log('   Consider tick array loading for inactive price ranges');
