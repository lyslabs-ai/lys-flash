...
describe('Batched Operations Integration Tests', () => {
  ...
  describe('Mixed Operation Types', () => {
    it(
      'should batch system transfer + SPL token transfer',
      async () => {
    ...
    it(
      'should batch SPL token operations (approve + transfer)',
      async () => {
        const response = await new TransactionBuilder(client)
          .splTokenApprove({
            mint: testMint,
    ...
    it(
      'should batch create ATA + token transfer',
      async () => {
        const response = await new TransactionBuilder(client)
          .splTokenCreateATA({
            payer: testWallet,
    ...
    it(
      'should batch multiple system transfers',
      async () => {
        const response = await new TransactionBuilder(client)
          .systemTransfer({
            sender: testWallet,
  ...
  describe('Pump.fun Batched Operations', () => {
    it(
      'should batch pump.fun buy + sell',
      async () => {
        const response = await new TransactionBuilder(client)
          .pumpFunBuy({
            pool: testPumpPool,
    ...
    it(
      'should batch buy operations with different amounts',
      async () => {
        const response = await new TransactionBuilder(client)
          .pumpFunBuy({
            pool: testPumpPool,
  ...
  describe('AMM Batched Operations', () => {
    ...
    it(
      'should batch multiple AMM buy operations',
      async () => {
        const response = await new TransactionBuilder(client)
          .pumpFunAmmBuy({
            pool: ammPool,
  ...
  describe('Complex Multi-Protocol Workflows', () => {
    it(
      'should batch pump.fun + system transfer + SPL token',
      async () => {
        const response = await new TransactionBuilder(client)
          .pumpFunBuy({
            pool: testPumpPool,
    ...
    it(
      'should batch approve + transfer + revoke flow',
      async () => {
        const response = await new TransactionBuilder(client)
          .splTokenApprove({
            mint: testMint,
    ...
    it(
      'should batch mint + transfer + burn flow',
      async () => {
        const response = await new TransactionBuilder(client)
          .splTokenMintTo({
            mint: testMint,
  ...
  describe('Builder State Management', () => {
    ...
    it(
      'should reset state correctly after batched execution',
      async () => {
        const builder = new TransactionBuilder(client);
    ...
    it(
      'should allow reusing builder after reset',
      async () => {
        const builder = new TransactionBuilder(client);
  ...
  describe('Priority Fees with Batched Operations', () => {
    it(
      'should handle high priority fee with multiple operations',
      async () => {
        const response = await new TransactionBuilder(client)
          .systemTransfer({
            sender: testWallet,
    ...
    it(
      'should handle zero priority fee with batched operations',
      async () => {
        const response = await new TransactionBuilder(client)
          .systemTransfer({
            sender: testWallet,
    ...
    it(
      'should handle custom bribe with batched operations',
      async () => {
        const response = await new TransactionBuilder(client)
          .systemTransfer({
            sender: testWallet,
  ...
  describe('Transport Modes with Batched Operations', () => {
    it(
      'should batch operations in SIMULATE mode',
      async () => {
        const response = await new TransactionBuilder(client)
          .systemTransfer({
            sender: testWallet,
    ...
    it(
      'should batch operations in VANILLA mode',
      async () => {
        const response = await new TransactionBuilder(client)
          .systemTransfer({
            sender: testWallet,
  ...
  describe('Large Batch Scenarios', () => {
    it(
      'should handle 5 operations in single transaction',
      async () => {
        const response = await new TransactionBuilder(client)
          .systemTransfer({
            sender: testWallet,
    ...
    it(
      'should handle 10 system transfers in single transaction',
      async () => {
        ...
        const response = await builder.setFeePayer(testWallet).setPriorityFee(1_000_000).simulate();
  ...
  describe('Error Scenarios', () => {
    it(
      'should handle validation error in batched operations',
      async () => {
        const builder = new TransactionBuilder(client);
    ...
    it(
      'should validate all operations before sending',
      () => {
        const builder = new TransactionBuilder(client);
