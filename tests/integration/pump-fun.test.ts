...
describe('Pump.fun Integration Tests', () => {
  ...
  describe('BUY Operation', () => {
    it('should simulate buy on bonding curve', async () => {
    ...
    it('should simulate buy with builder pattern', async () => {
  ...
  describe('SELL Operation', () => {
    it('should simulate sell on bonding curve', async () => {
      const response = await client.execute({
        data: {
          executionType: 'PUMP_FUN',
          eventType: 'SELL',
    ...
    it('should simulate sell with builder pattern', async () => {
      const response = await new TransactionBuilder(client)
        .pumpFunSell({
          pool: '5dxJHyvvhnEHV3ZH5BaNv66gmFy7NKrFbjpefryNpump',
          poolAccounts: {
    ...
    it('should simulate sell with ATA closure', async () => {
      const response = await new TransactionBuilder(client)
        .pumpFunSell({
          pool: '5dxJHyvvhnEHV3ZH5BaNv66gmFy7NKrFbjpefryNpump',
          poolAccounts: {
    ...
    it('should simulate sell with slippage protection', async () => {
      const response = await new TransactionBuilder(client)
        .pumpFunSell({
          pool: '5dxJHyvvhnEHV3ZH5BaNv66gmFy7NKrFbjpefryNpump',
          poolAccounts: {
  ...
  describe('CREATE Operation', () => {
    it('should simulate token creation', async () => {
      ...
      const response = await new TransactionBuilder(client)
        .pumpFunCreate({
          ...
          mintSecretKey: 'AwEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQ==', // Test secret
          meta: {
            name: 'Test Token',
            symbol: 'TEST',
    ...
    it('should validate metadata fields', async () => {
      const response = await new TransactionBuilder(client)
        .pumpFunCreate({
          ...
          mintSecretKey: 'AwEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQ==',
          meta: {
  ...
  describe('MIGRATE Operation', () => {
    it('should simulate migration to Raydium AMM', async () => {
      const response = await new TransactionBuilder(client)
        .pumpFunMigrate({
    ...
    it('should simulate migration with direct execute', async () => {
      const response = await client.execute({
        data: {
          executionType: 'PUMP_FUN',
          eventType: 'MIGRATE',
  ...
  describe('Multi-Operation Scenarios', () => {
    it('should simulate buy + sell flow', async () => {
      const response = await new TransactionBuilder(client)
        .pumpFunBuy({
          pool: '5dxJHyvvhnEHV3ZH5BaNv66gmFy7NKrFbjpefryNpump',
          poolAccounts: {
    ...
    it('should simulate create + buy flow', async () => {
      const response = await new TransactionBuilder(client)
        .pumpFunCreate({
          user: '5ZkoYMeNTjUA56k6rXSyRb9zf1HzR8SZ5YdYM2edfK89',
          pool: '7xKXtg2CW87d97TXJSDpbD5jBkheTqA83TZRuJosgAsU',
