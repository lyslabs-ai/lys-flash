...
describe('SPL Token Integration Tests', () => {
  ...
  describe('TRANSFER Operation', () => {
    it(
      'should simulate token transfer',
      async () => {
    ...
    it(
      'should simulate with builder pattern',
      async () => {
    ...
    it(
      'should handle different transfer amounts',
      async () => {
    ...
    it(
      'should handle minimal transfer (1 token unit)',
      async () => {
        const response = await new TransactionBuilder(client)
          .splTokenTransfer({
            mint: testMint,
  ...
  describe('TRANSFER_CHECKED Operation', () => {
    it(
      'should simulate transfer with decimals validation',
      async () => {
        const response = await client.execute({
          data: {
            executionType: 'SPL_TOKEN',
    ...
    it(
      'should validate decimals parameter',
      async () => {
  ...
  describe('CREATE_ATA Operation', () => {
    ...
    it(
      'should create ATA for different owner',
      async () => {
        const response = await new TransactionBuilder(client)
          .splTokenCreateATA({
  ...
  describe('CLOSE_ACCOUNT Operation', () => {
    it(
      'should simulate account closure',
      async () => {
        const response = await client.execute({
          data: {
            executionType: 'SPL_TOKEN',
  ...
  describe('APPROVE Operation', () => {
    it(
      'should simulate token approval',
      async () => {
        const response = await client.execute({
          data: {
            executionType: 'SPL_TOKEN',
    ...
    it(
      'should handle different approval amounts',
      async () => {
  ...
  describe('REVOKE Operation', () => {
    it(
      'should simulate approval revocation',
      async () => {
        const response = await client.execute({
          data: {
            executionType: 'SPL_TOKEN',
  ...
  describe('MINT_TO Operation', () => {
    ...
    it(
      'should handle different mint amounts',
      async () => {
  ...
  describe('BURN Operation', () => {
    ...
    it(
      'should handle different burn amounts',
      async () => {
  ...
  describe('SYNC_NATIVE Operation', () => {
    it(
      'should simulate native SOL sync',
      async () => {
        const response = await client.execute({
          data: {
            executionType: 'SPL_TOKEN',
  ...
  describe('Multi-Operation Flows', () => {
    it(
      'should simulate approve + transfer flow',
      async () => {
        const response = await new TransactionBuilder(client)
          .splTokenApprove({
            mint: testMint,
    ...
    it(
      'should simulate approve + revoke flow',
      async () => {
        const response = await new TransactionBuilder(client)
          .splTokenApprove({
            mint: testMint,
    ...
    it(
      'should simulate create ATA + transfer flow',
      async () => {
        const response = await new TransactionBuilder(client)
          .splTokenCreateATA({
            payer: testUser,
