...
describe('System Transfer Integration Tests', () => {
  ...
  describe('SIMULATE Mode', () => {
    it(
      'should simulate SOL transfer successfully',
      async () => {
    ...
    it(
      'should simulate transfer with zero priority fee',
      async () => {
        const response = await new TransactionBuilder(client)
          .systemTransfer({
            sender: '5ZkoYMeNTjUA56k6rXSyRb9zf1HzR8SZ5YdYM2edfK89',
    ...
    it(
      'should simulate large transfer',
      async () => {
        const response = await new TransactionBuilder(client)
          .systemTransfer({
            sender: '5ZkoYMeNTjUA56k6rXSyRb9zf1HzR8SZ5YdYM2edfK89',
    ...
    it(
      'should simulate with custom bribe amount',
      async () => {
        const response = await new TransactionBuilder(client)
          .systemTransfer({
            sender: '5ZkoYMeNTjUA56k6rXSyRb9zf1HzR8SZ5YdYM2edfK89',
  ...
  describe('Client Statistics', () => {
    it(
      'should track successful simulation requests',
      async () => {
    ...
    it(
      'should update latency statistics',
      async () => {
        client.resetStats();
  ...
  describe('Edge Cases', () => {
    it(
      'should handle minimal transfer amount',
      async () => {
        const response = await new TransactionBuilder(client)
          .systemTransfer({
            sender: '5ZkoYMeNTjUA56k6rXSyRb9zf1HzR8SZ5YdYM2edfK89',
  ...
  describe('Builder Reuse', () => {
    it(
      'should allow builder reset and reuse',
      async () => {
  ...
  describe('Ping Connectivity', () => {
    it(
      'should ping execution engine successfully',
      async () => {
    ...
    it(
      'should maintain connection across multiple pings',
      async () => {
        for (let i = 0; i < 5; i++) {
          const result = await client.ping();
          expect(result).toBe(true);
