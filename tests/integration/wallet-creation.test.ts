...
import { createTestClient, assertSuccessResponse } from '../test-utils';
...
describe('Wallet Creation Integration Tests', () => {
  ...
  describe('CREATE_WALLET Operation', () => {
    ...
    it(
      'should create wallet with builder pattern',
      async () => {
    ...
    it(
      'should create multiple wallets with different sessions',
      async () => {
    ...
    it(
      'should handle strong passwords',
      async () => {
  ...
  describe('GET_WALLET Operation', () => {
    ...
    it(
      'should retrieve existing wallet',
      async () => {
        const response = await client.execute({
          data: {
            executionType: 'WALLET',
    ...
    it(
      'should retrieve wallet with builder pattern',
      async () => {
        const response = await new TransactionBuilder(client)
          .getWallet({
            sessionId: testSessionId,
    ...
    it(
      'should fail with non-existent session',
      async () => {
        const response = await client.execute({
          data: {
            executionType: 'WALLET',
  ...
  describe('DELETE_WALLET Operation', () => {
    it(
      'should delete wallet successfully',
      async () => {
    ...
    it(
      'should delete wallet with builder pattern',
      async () => {
    ...
    it(
      'should not retrieve wallet after deletion',
      async () => {
    ...
    it(
      'should fail deletion with incorrect password',
      async () => {
  ...
  describe('Wallet Lifecycle', () => {
    it(
      'should handle complete create -> get -> delete lifecycle',
      async () => {
    ...
    it(
      'should handle multiple wallets in parallel sessions',
      async () => {
        const sessions = [
  ...
  describe('Wallet with Transactions', () => {
    it(
      'should use created wallet for transaction signing',
      async () => {
    ...
    it(
      'should handle wallet in batched operations',
      async () => {
  ...
  describe('Security and Encryption', () => {
    it(
      'should store wallet with encrypted private key',
      async () => {
  ...
  describe('Edge Cases', () => {
    it(
      'should handle very short password',
      async () => {
