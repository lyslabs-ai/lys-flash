...
describe('Performance Tests - Concurrent Requests', () => {
  ...
  describe('Parallel Execution', () => {
    ...
    it(
      'should handle 20 concurrent requests',
      async () => {
  ...
  describe('Throughput Tests', () => {
    it(
      'should measure throughput for simple operations',
      async () => {
    ...
    it(
      'should measure throughput for batched operations',
      async () => {
        const batchCount = 20;
        const start = Date.now();
  ...
  describe('Sequential vs Parallel Comparison', () => {
    it(
      'should compare sequential vs parallel execution',
      async () => {
  ...
  describe('Mixed Operation Concurrency', () => {
    ...
    it(
      'should handle concurrent batched operations',
      async () => {
        const batchCount = 10;
  ...
  describe('Error Handling Under Load', () => {
    it(
      'should track statistics accurately under concurrent load',
      async () => {
  ...
  describe('Client Connection Stability', () => {
    it(
      'should remain connected after high concurrent load',
      async () => {
        // High load
    ...
    it(
      'should handle ping under concurrent load',
      async () => {
