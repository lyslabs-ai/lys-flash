...
describe('Performance Tests - Latency', () => {
  ...
  describe('SIMULATE Mode Latency', () => {
    it('should have minimal latency for simulation', async () => {
    ...
    it('should measure SPL token operation latency', async () => {
      const latencies: number[] = [];
    ...
    it('should measure Pump.fun operation latency', async () => {
      const latencies: number[] = [];
  ...
  describe('VANILLA Mode Latency', () => {
    it('should measure vanilla RPC latency', async () => {
      const latencies: number[] = [];
  ...
  describe('Batched Operations Latency', () => {
    it('should measure latency for small batch (2 operations)', async () => {
      const latencies: number[] = [];
    ...
    it('should measure latency for medium batch (5 operations)', async () => {
      const latencies: number[] = [];
    ...
    it('should measure latency for large batch (10 operations)', async () => {
      const latencies: number[] = [];
  ...
  describe('Operation Type Comparison', () => {
    it('should compare latency across operation types', async () => {
      ...
      results['System Transfer'] = systemLatencies.reduce((a, b) => a + b) / systemLatencies.length;
  ...
  describe('Consistency Tests', () => {
    it('should have consistent latency across multiple runs', async () => {
      const latencies: number[] = [];
      ...
      const avg = latencies.reduce((a, b) => a + b, 0) / latencies.length;
      const variance =
        latencies.reduce((sum, latency) => sum + Math.pow(latency - avg, 2), 0) / latencies.length;
    ...
    it('should maintain latency under sequential load', async () => {
      const latencies: number[] = [];
  ...
  describe('Cold Start vs Warm', () => {
    ...
    it('should compare cold vs warm latency', async () => {
      // Cold start
      const coldClient = createTestClient();
      const { latency: coldLatency } = await measureLatency(async () => {
        return await new TransactionBuilder(coldClient)
